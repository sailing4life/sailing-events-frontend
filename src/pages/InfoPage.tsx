  ...
  const sections = [
    ...
    },
    {
      ...
      content: [
        {
          subtitle: 'Backend',
          text: 'FastAPI (Python) draait lokaal op deze Windows PC. Start via start-backend.bat. Bereikbaar via cloudflared tunnel op https://api2.jellelourens.nl.',
        },
        {
          subtitle: 'Frontend',
          text: 'React app gehost op Vercel. Bereikbaar via https://th-events.jellelourens.nl. Elke push naar de "sailing-events-frontend" GitHub repo triggert automatisch een nieuwe Vercel deploy.',
        },
        {
          subtitle: 'Database',
        ...
        },
        {
          ...
          text: 'Emails worden verstuurd via Resend.com met het domein @jellelourens.nl. API key staat in backend/.env als RESEND_API_KEY.',
        },
      ],
    },
    {
    ...
    },
    {
      ...
      content: [
        { subtitle: 'sailing4life/sailing-events-frontend', text: 'Frontend React code. Push hier naar main → Vercel deployt automatisch naar th-events.jellelourens.nl.' },
